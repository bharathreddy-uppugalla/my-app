...
const footerLinks = {
  ...
  "Students/Graduates": [
    { label: "Become an Intern",  path: "/students" },
    { label: "Grad Jobs",    path: "/students" },
    { label: "Workshop",          path: "/students" },
    { label: "Mentor Program",    path: "/students" },
    { label: "Coaching",       path: "/students" },
  ],
  "Industry/Business": [
    { label: "Workshops",  path: "/Industry" },
    { label: "Up-skill staff",    path: "/Industry" },
    { label: "Support",    path: "/Industry" },
  ],
  "Testimonals": [
    { label: "Our students",       path: "/Testimonals" },
    { label: "Our Graduates",         path: "/Testimonals" },
    { label: "Professionals",  path: "/Testimonals" },
  ],
